...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                ...
                // blob: — cannot navigate, intercept via JS
                if (url.startsWith("blob:")) {
                    interceptBlobDownload(url);
                    return true;
                }

                // Custom URI schemes: whatsapp://, upi://, tel:, mailto:, tg:, intent: etc.
                // Hand off to Android OS to open the correct app.
                ...
                // Normal http/https — load inside WebView
                return false;
            }
            ...
            public void onReceivedError(WebView view, WebResourceRequest request,
                ...
                // Suppress ERR_UNKNOWN_URL_SCHEME — already handled by openExternalScheme
    ...
    // whatsapp://, upi://, tel:, mailto:, tg:, intent:, market:, etc.
    // =========================================================

    /**
     * Fire an Android Intent for any non-http URI scheme.
     * Makes whatsapp://, upi://, tel:, mailto:, tg: etc. all open correctly.
     */
    private boolean openExternalScheme(String url) {
        Log.d(TAG, "openExternalScheme: " + url);

        // Strategy: NEVER use resolveActivity() — on Android 11+ it returns null
        // even when the target app IS installed, unless declared in <queries>.
        // Instead: always call startActivity() directly and catch ActivityNotFoundException.

        // Step 1: Try whatsapp:// specially — use ACTION_VIEW with the wa.me fallback
        if (url.startsWith("whatsapp://")) {
            // Try native WhatsApp intent first
            try {
                ...
                try {
                    ...
                    // Try without specifying package (shows chooser)
                    try {
                        ...
                        Log.e(TAG, "WhatsApp not found", e3);
        ...
        // Step 2: UPI — always works via ACTION_VIEW, all UPI apps respond to upi://
        ...
        // Step 5: intent: scheme — parse and launch
        ...
        // Step 6: All other custom schemes (tg://, market://, geo://, etc.)
        try {
